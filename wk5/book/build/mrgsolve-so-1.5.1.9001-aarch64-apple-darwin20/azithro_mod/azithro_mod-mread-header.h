...
// DEFS:
#define __INITFUN___ _model_azithro__mod_main__
#define __ODEFUN___ _model_azithro__mod_ode__
#define __TABLECODE___ _model_azithro__mod_table__
#define __EVENTFUN___ _model_azithro__mod_event__
#define __CONFIGFUN___ _model_azithro__mod_config__
#define __REGISTERFUN___ R_init_azithro_mod
#define _nEQ 4
#define _nPAR 8
